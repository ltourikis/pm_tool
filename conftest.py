...
def general_setup_teardown():
    """
    Fixture for setting up and tearing down the WebDriver session for general module-level tests.
...
def settings_setup():
    """
    Fixture for setting up and tearing down the WebDriver session specifically for settings-related tests.
